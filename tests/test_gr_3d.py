...
from gr_3d import generate_one_conf
from gr_3d import compute_distances
from gr_3d import compute_gr_3d
from gr_3d import plot_gr
...
class test_gr_3d():
    ...
    def test_compute_gr_3d(self):
        N = 25
        dim = 3
        L = 100.0
        x = generate_one_conf(L, N, dim)
        dist = compute_distances(x, L, N, dim)
        r, gr = compute_gr_3d(dist, N, nbins=100)
