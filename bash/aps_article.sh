...
# to use a proxy, uncomment the next line and set the correct address
...
if [ "$HOMEPAGE" == '0' ]; then
 LINK=http://journals.aps.org$PROXY/$JOURNAL_lo/abstract/10.1103/$JOURNAL_long.$VOL.$PAGE
else
